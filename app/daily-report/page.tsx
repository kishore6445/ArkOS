        ...
        <div className="mb-8 bg-gradient-to-r from-slate-950 to-slate-900 rounded-xl p-8 text-white">
          <div className="space-y-4">
            ...
            <p className="text-xl text-slate-300">
              Your daily updates are how we track execution. Every day matters. Every action counts toward Mission 30.
            </p>
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-700">
              <div>
                <p className="text-sm text-slate-400">Your 30% Hike Depends On</p>
                <p className="text-2xl font-black text-orange-500">Daily Execution</p>
              </div>
              <div>
                <p className="text-sm text-slate-400">Mission 30 Tracked By</p>
